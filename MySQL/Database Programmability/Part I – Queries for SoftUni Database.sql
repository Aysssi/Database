...
DELIMITER $$
CREATE PROCEDURE usp_get_employees_from_town(searched_name VARCHAR(20))
BEGIN
    SELECT first_name,last_name FROM employees AS e
  JOIN addresses AS a ON e.address_id = a.address_id /*  USING (adress_id) */
  JOIN towns AS t USING (town_id) /*ON a.town_id = t.town_id*/ 
