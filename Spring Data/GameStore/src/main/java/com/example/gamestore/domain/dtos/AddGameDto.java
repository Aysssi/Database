...
public class AddGameDto {
    @Pattern(regexp = "[A-Z][a-z]{6,100}",message = "Enter valid title. Title has to begin with an uppercase letter and must have length between 3 and 1")
    ...
    @Length(min = 20, message = "Must be at leas 20 symbols")
